...
if __name__ == '__main__':
    ...
    models = [
        ('Proportional fair agonistic', CustomRewardModel(THETAs[1]), ProportionalFairnessModel(K, p0=p0, use_gaps=True, invert=True),'Proportional fair agonistic'),
        ('Proportional fair antagonistic', CustomRewardModel(THETAs[1]), ProportionalFairnessModel(K, p0=p0, use_gaps=True, invert=False),'Proportional fair antagonistic'),
    ]
